    ...
    pub fn Protocol(comptime ContextType: type) type {
        return struct {
            pub fn Derive(comptime _delegate_handlers: HandlerSet, comptime SuffixIdSeed: type) type {
                return struct {
                    const _class_name = runtime.backend_support.concreteTypeName("NSChangeSpelling", SuffixIdSeed.generateIdentifier());
                    ...
                    pub fn initWithContext(context: *ContextType) Self {
                        ...
                        var _instance = runtime.wrapObject(NSChangeSpelling, _id);
