    ...
    pub fn Protocol(comptime ContextType: type) type {
        return struct {
            pub fn Derive(comptime _delegate_handlers: HandlerSet, comptime SuffixIdSeed: type) type {
                return struct {
                    const _class_name = runtime.backend_support.concreteTypeName("NSUserInterfaceValidations", SuffixIdSeed.generateIdentifier());
                    ...
                    pub fn initWithContext(context: *ContextType) Self {
                        ...
                        var _instance = runtime.wrapObject(NSUserInterfaceValidations, _id);
...
pub const NSValidatedUserInterfaceItem = struct {
    ...
    pub fn Protocol(comptime ContextType: type) type {
        return struct {
            pub fn Derive(comptime _delegate_handlers: HandlerSet, comptime SuffixIdSeed: type) type {
                return struct {
                    const _class_name = runtime.backend_support.concreteTypeName("NSValidatedUserInterfaceItem", SuffixIdSeed.generateIdentifier());
                    var _class: ?objc.Class = null;
                    ...
                    pub fn initWithContext(context: *ContextType) Self {
                        ...
                        var _instance = runtime.wrapObject(NSValidatedUserInterfaceItem, _id);
                        runtime.ContextReg(ContextType).setContext(_id, context);
                        return _instance;
                    }
                };
